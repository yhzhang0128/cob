...
| Figure    | Experiment     | Claim                                                                                      |
|-----------|----------------|--------------------------------------------------------------------------------------------|
| Figure 8  | Exp #1, #2, #3 | The 3 baseline systems are all vulnerable to bias.                                         |
| Figure 9  | Exp #4         | Pompe-SRO can control the degree of bias under a target Ɛ.                                 |
| Figure 10 | Exp #5         | Attacker gets the mean reward in Pompe-SRO and the max in baselines                        |
| Figure 11 | Exp #6         | SRO latency is low and SRO is not the performance bottleneck in Pompe-SRO.                 |
| Figure 12 | Exp #7, #8     | Pompe-SRO maintains the same end-to-end throughput as Pompe and incurs a latency overhead. |
